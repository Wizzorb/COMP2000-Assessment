...
public class stockDatabase {
    ...
    public void readStock() {   //Primary code for database access, reads the entirety of the textfile into Stock arraylist.
        try {
    ...
    public void searchDB(Integer searchID) {    //Searches the database and populates the variables with the search results.
        readStock();
    ...
    public void writeFile(File wFile, String newS) throws IOException {     //Appends the textfile with a new database entry.
    ...
    public void removeFile(String dID, String dName, String dPrice, String dQuantity) throws IOException {      // Deletes a database entry with inserted values.
    ...
    public void dBQuantityChange(String itemID, Integer qChangeAmount, boolean plusMinus) throws IOException {      //Changes the quantity of a stock with the inserted values.
        readStock();
    ...
    public ArrayList<String> getStock() {
        return Stock;
    }   //Returns the stock for other packages.

    public void priceTotal(ArrayList<Integer> prices) {     //Calculates the total of a arraylist of prices.
    ...
    public String getSPriceTotal() {
        return sPriceTotal;
    }   //Returns the price total, although might not have been required.

    public int lengthStock() {  //Returns the amount of entries in the Stock arraylist.
